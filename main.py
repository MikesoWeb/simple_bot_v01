...
print(
    f'{rand_users[0]}: --> Меня зовут {rand_users[0]}, я из Таллина мне 17 лет.')
sleep(2)
...
if 'солнечно' in weather:
    sleep(3)
    print(
        f'{rand_users[0]}: Обожаю солнце! Я бы пошел купаться, ведь лето же.')

if 'пасмурно' in weather:
    sleep(3)
    print(
        f'{rand_users[0]}: Некоторые любят такую погоду. Тёплый плед и горячий чай...у камина...')

else:
    sleep(2)
    print(
        f'{rand_users[0]}: Чтож! Одни любят когда солнечно,другие когда пасмурно. Всем не угодишь =))')
sleep(1)
game = input(
    f'{rand_users[0]}:Слушай, а какая у тебя самая любимая игра на компе?')
sleep(2)

print(
    f'{rand_users[0]}: {game} да клевая игрушка, я играл в нее недавно, перепроходил')
sleep(1.5)
...
if 'супер' in nfs:
    print(
        f'{rand_users[0]}: Рад что тебе поже нравится эта часть. Графон супер!')
if 'неочень' in nfs:
    print(f'{rand_users[0]}: Жаль что тебе не понравилась =(')
else:
    print(
        f'{rand_users[0]}: Всегда так) кому-то нравится, кому-то нет. Но все равно раньше игры лучше делали!')

sleep(1.4)
print(
    f'{rand_users[0]}: Слушай, мне пора на тренировку, потом спишемся еще =)) ')
sleep(1.5)
